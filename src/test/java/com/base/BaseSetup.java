...
public class BaseSetup implements TimeOuts {
	...
	public void beforeSuite() throws Exception {
		...
		DOMConfigurator.configure(userDir+File.separator+"ConfigFiles"+File.separator+"log4j.xml");
	...
	@BeforeMethod(alwaysRun = true)
	public void initializeBaseSetupForRemote(@Optional("edge") String browserType,
