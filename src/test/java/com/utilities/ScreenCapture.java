...
public class ScreenCapture  
{
	...
	public static String stopVideoCapture(String sVideoFileName)
	{
		...
		try
		{
			...
			{
				screenRecorder.stop();
				dateAndTime=renameCapturedVideoFile(sVideoFileName);
			}
		}
	...
	public static String renameCapturedVideoFile(String sVideoFileName)
	{
		...
		try
		{
		    ...
		    File newfile = null;
		    dateAndTime=UtilityMethods.getCurrentDateTime();
		    if(!new File(ReportSetup.getVideosPath()+fileSeperator+sVideoFileName+dateAndTime+ ".avi").exists())
		    {
		    	newfile = new File(ReportSetup.getVideosPath()+fileSeperator+sVideoFileName+dateAndTime+".avi");
		    }
		    else
		    {
