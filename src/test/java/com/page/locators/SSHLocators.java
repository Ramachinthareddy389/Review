...
public interface SSHLocators {
    ...
    By BTN_DISABLE = By.xpath("//h5[text()='Secure Shell']/..//div[@aria-label='Disable Selected Configuration']");
    By BTN_CLONE = By.xpath("//h5[text()='Secure Shell']/..//div[@aria-label='Clone Selected Configuration']");
    By BTN_STATUS = By.xpath("//h5[text()='Secure Shell']/..//div[@aria-disabled='true']");
    By HEADER_CLONED = By.xpath("//div[@aria-label='Save Configuration']/../../h5");
    By BTN_DELETE = By.xpath("//h5[text()='Secure Shell']/..//div[@aria-label='Remove Selected Configuration']");
    By BTN_EDIT = By.xpath("//h5[text()='Secure Shell']/..//div[@aria-label='Edit Selected Configuration']");
    ...
    By BTN_EXECUTE = By.xpath("//h5[text()='Secure Shell']/..//div[@aria-label='Execute']");
