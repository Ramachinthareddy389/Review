...
public class CorrelationPage extends SafeActions implements CorrelationLocators {
    ...
    public void EditLeftStreamFeildsWithNewValues() {
        ...
        Edited_LStreamKpis_Add = safeGetText(EDITED_LSTREAM_KPIS, "Kpis", MEDIUMWAIT);
    ...
    public void EditRightStreamFeildsWithNewValues() {
        ...
        Edited_RStreamKpis_Add = safeGetText(EDITED_RSTREAM_KPIS, "Kpis", MEDIUMWAIT);
    ...
    public void verifyingEditedStreamCorrelationValues() {
        ...
        System.out.println(Edited_Name_Add + ":" + driver.findElement(TXTBOX_EDITED_NAME).getAttribute("value") + Edited_LStreamName_Add + ":" + driver.findElement(EDITED_LSTREAM_NAME_TXTBOX).getAttribute("value") +
            Edited_LStreamTimeToLive_Add + driver.findElement(EDITED_LSTREAM_TIMETOLIVE_TXTBOX).getAttribute("value") + Edited_LStreamKpis_Add + driver.findElement(EDITED_LSTREAM_KPIS).getText() + Edited_LStreamPartition_Add + driver.findElement(EDITED_LSTREAM_PARTITION_KEY).getText() + Edited_LStreamOrderby_Add + driver.findElement(EDITED_LSTREAM_ORDER_BY).getText() + Edited_RStreamName_Add + ":" + driver.findElement(EDITED_RSTREAM_NAME_TXTBOX).getAttribute("value") + Edited_RStreamTimeToLive_Add + ":" + driver.findElement(EDITED_RSTREAM_TIMETOLIVE_TXTBOX).getAttribute("value") + Edited_RStreamKpis_Add+ ":" + driver.findElement(EDITED_RSTREAM_KPIS).getText() + Edited_RStreamPartition_Add+ ":" + driver.findElement(EDITED_RSTREAM_PARTITION_KEY).getText() + Edited_RStreamOrderby_Add + ":" + driver.findElement(EDITED_RSTREAM_ORDER_BY).getText() + EditedCostFun_add + ":" + driver.findElement(EDITED_COST_FUNCTION).getText() +EditedPairFun_add+ ":" + driver.findElement(EDITED_PAIR_FUNCTION).getText());
        ...
        if (Edited_Name_Add.equals(driver.findElement(TXTBOX_EDITED_NAME).getAttribute("value")) && Edited_LStreamName_Add.equals(driver.findElement(EDITED_LSTREAM_NAME_TXTBOX).getAttribute("value")) &&
                Edited_LStreamTimeToLive_Add.equals(driver.findElement(EDITED_LSTREAM_TIMETOLIVE_TXTBOX).getAttribute("value")) && Edited_LStreamKpis_Add.equals(driver.findElement(EDITED_LSTREAM_KPIS).getText()) && Edited_LStreamPartition_Add.equals(driver.findElement(EDITED_LSTREAM_PARTITION_KEY).getText()) && Edited_LStreamOrderby_Add.equals(driver.findElement(EDITED_LSTREAM_ORDER_BY).getText()) && Edited_RStreamName_Add.equals(driver.findElement(EDITED_RSTREAM_NAME_TXTBOX).getAttribute("value")) && Edited_RStreamTimeToLive_Add.equals(driver.findElement(EDITED_RSTREAM_TIMETOLIVE_TXTBOX).getAttribute("value")) && Edited_RStreamKpis_Add.equals(driver.findElement(EDITED_RSTREAM_KPIS).getText()) && Edited_RStreamPartition_Add.equals(driver.findElement(EDITED_RSTREAM_PARTITION_KEY).getText()) && Edited_RStreamOrderby_Add.equals(driver.findElement(EDITED_RSTREAM_ORDER_BY).getText()) && EditedCostFun_add.equals(driver.findElement(EDITED_COST_FUNCTION).getText()) && EditedPairFun_add.equals(driver.findElement(EDITED_PAIR_FUNCTION).getText())) {
