...
public class SafeActions extends Sync
{
	...
	private Logger log =Logger.getLogger("SafeActions");
...
//		}
	...
	/*public void safeSelectOptionInDropDown(By locator, String optionToSelect, int... optionWaitTime)
	{
		try
		{
			...
			{
				log.error(getTestCasename()+"Unable to select " + optionToSelect + " from " + locator + UtilityMethods.getStackTrace());
				Assert.fail("Unable to select " + optionToSelect + " from " + locator + UtilityMethods.getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
			log.error(getTestCasename()+"Element with dropdown locator- " + locator + " or option to be selected -'"+optionToSelect+"' webelement is not attached to the page document"+UtilityMethods.getStackTrace());
		...
		{
			log.error(getTestCasename()+"Element with dropdown locator- " + locator + " or option to be selected -'"+optionToSelect+"' webelement was not found in DOM"+UtilityMethods.getStackTrace());
